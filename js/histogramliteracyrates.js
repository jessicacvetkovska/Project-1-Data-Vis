class HistogramLiteracyRates {
    ...
    initVis() {
        ...
        vis.chart.append("text")
            ...
            .text("Literacy Rate vs Number of Countries"); // Set the actual text of the title
        ...
        vis.chart.append("text")
            ...
            .text("Frequency of Literacy Rates (%)");
